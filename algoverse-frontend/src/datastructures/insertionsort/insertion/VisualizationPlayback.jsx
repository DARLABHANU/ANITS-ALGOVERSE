...
import InsertionSortVisualizer from './insertion';
...
const VisualizationPlayback = () => {
  ...
  const InsertionVisualizerRef = useRef(null);
  ...
  const handleRestart = () => {
    ...
    if (InsertionVisualizerRef.current?.reset) {
      InsertionVisualizerRef.current.reset();
    }
  };
