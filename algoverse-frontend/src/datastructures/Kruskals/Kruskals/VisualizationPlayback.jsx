...
import KruskalsVisualizer from './kruskal';
...
const VisualizationPlayback = () => {
  ...
  const KruskalsVisualizerRef = useRef(null);
  ...
  const handleRestart = () => {
    ...
    if (KruskalsVisualizerRef.current?.reset) {
      KruskalsVisualizerRef.current.reset();
    }
  };
