...
import VisualizationPlayback from './selection/VisualizationPlayback';
import { 
  ChevronLeft,
  User,
  Check,
          ...
          <div className="px-3 sm:px-4 py-2 sm:py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                <div className="text-sm sm:text-lg font-semibold gradient-text truncate">Selection Sort</div>
              </div>
...
const PseudocodeSection = () => (
  <Card className="h-full algo-card">
    <CardContent className="p-4 sm:p-8 h-full flex flex-col">
      <h1 className="section-title gradient-text">Selection Sort Pseudocode</h1>
...
const FlowchartSection = () => (
  <Card className="algo-card">
    <CardContent className="p-4 sm:p-8 flex flex-col">
      <h1 className="section-title gradient-text">Selection Sort Flowchart</h1>
      <div className="flex justify-center items-center mt-4">
        <div className="glass-card p-8 rounded-2xl w-full border border-primary/20">
          <img
            src="https://ik.imagekit.io/1aqvo9gfn/Selection%20sort.jpg?updatedAt=1751567779546"
            alt="Selection Sort Flowchart"
...
const AdvantagesSection = () => (
  <Card className="h-full algo-card">
    <CardContent className="p-4 sm:p-8 h-full flex flex-col">
      <h1 className="section-title gradient-text">Advantages of Selection Sort</h1>
...
const ExamplesSection = () => (
  <Card className="h-full algo-card">
    <CardContent className="p-4 sm:p-8 h-full flex flex-col">
      <h1 className="section-title gradient-text">Selection Sort Examples</h1>
