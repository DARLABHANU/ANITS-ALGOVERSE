...
import SelectionSortVisualizer from './selection';
...
const VisualizationPlayback = () => {
  ...
  const SelectionVisualizerRef = useRef(null);
  ...
  const handleRestart = () => {
    ...
    if (SelectionVisualizerRef.current?.reset) {
      SelectionVisualizerRef.current.reset();
    }
  };
