...
const Algorithms = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-orange-50/30 to-yellow-50/30 dark:from-background dark:via-orange-950/30 dark:to-yellow-950/30">
      {/* Watermark */}
      <div className="watermark">Algorithms</div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="relative pt-8 pb-12">
          <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-primary font-medium">Algorithms</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Master <span className="gradient-text">Algorithm </span> Approaches
          </h1>

          <p className="text-xl text-muted-foreground mb-8 max-w-3xl">
            Learn different approaches of Algorithms to  Solve problems in real life scenarios. Apply various algorithms for efficiency of problem.
          </p>
          ...
          <Card>
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h2 className="text-2xl font-bold mb-4">What are Algorithms</h2>
                  <p className="text-muted-foreground mb-4">
                   Algorithms are step by step procedures to solve different problems and perform specific tasks.
                  </p>
                  <p className="text-muted-foreground mb-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-sm font-medium">Bruteforce</span>
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-sm font-medium">Dynamic approach</span>
                        <span className="text-sm text-muted-foreground">O(n)</span>
                      </div>
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div className="h-full bg-yellow-500 rounded-full w-[60%]"></div>
        ...
        {/* Examples Section */}
        <section className="mb-16">
          <h2 className="section-title gradient-text mb-8">Algorithms</h2>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Once you've mastered Algorithms, advance to  problem Solving.
                    ...
                    <Card className="relative z-10">
                      <CardContent className="p-6 space-y-3">
                        ...
                        <div className="flex items-center gap-3 text-sm">
                          ...
                          <span>optimizing the problem</span>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
